    ...
    commands: [
        {
            verifyHeaderLinks: function (pageUrl, testUrlValidation) {
                // Abstracts out the tests for the T1 & T2 Header links.
                ...
                // test pages
                //
                // Note: This is now split out into a Dektop version of the
                // page object. When you have a chance, might want to keep the
                // elements section of this page, but re-write the commands
                // section to be more like the uwmHeaderMobile.js commands section.
                var UWLogoImageSrc = pageUrl + '/themes/custom/uwmbase/dist/images/uw-medicine-logo.svg'
